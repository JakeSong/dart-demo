...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    "^": "",
    makeAdderFunction: function(addBy) {
      return new Z.makeAdderFunction_closure(addBy);
    },
    main: function() {
      var add2, add4;
      add2 = Z.makeAdderFunction(2);
      add4 = Z.makeAdderFunction(4);
      P.print("add2 is Function:true,add2.runtimeType = " + new H.TypeImpl(H.getRti(add2)).toString$0(0) + " ,add2(3) = " + H.S(add2.call$1(3)));
      P.print("add4 is Function:true,add4.runtimeType = " + new H.TypeImpl(H.getRti(add4)).toString$0(0) + ", add4(3)= " + H.S(add4.call$1(3)));
    },
    makeAdderFunction_closure: {
      "^": "Closure:0;addBy",
      call$1: function(i) {
        return this.addBy + i;
      }
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1, ret: P.num, args: [P.num]}];
