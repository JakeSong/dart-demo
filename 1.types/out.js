...
(function() {
  ...
  }], ["", "1.types&literals.dart",, V, {
    "^": "",
    main: function() {
      var list, map;
      P.print("null.runtimeType = " + C.JSNull_methods.get$runtimeType(null).toString$0(0));
      P.print("true.runtimeType = " + C.Type_bool_lhE.toString$0(0));
      P.print("1000000000000000000.runtimeType = " + C.Type_int_tHn.toString$0(0));
      P.print("5.12e10000.runtimeType = " + C.Type_int_tHn.toString$0(0));
      P.print("'str'.runtimeType = " + C.Type_String_k8F.toString$0(0));
      P.print("---------------list literal---------------");
      P.print("[].runtimeType = " + new H.TypeImpl(H.getRti([])).toString$0(0));
      list = [];
      list.push("a");
      list.push("b");
      list.push("c");
      C.JSArray_methods.$indexSet(list, 0, 1);
      P.print("list = " + H.S(list) + ", list.runtimeType = " + new H.TypeImpl(H.getRti(list)).toString$0(0));
      P.print("---------------map literal---------------");
      P.print("{}.runtimeType = " + new H.TypeImpl(H.getRti(P.LinkedHashMap__makeEmpty())).toString$0(0));
      map = P.LinkedHashMap__makeEmpty();
      map.$indexSet(0, "a", 1);
      map.$indexSet(0, "b", 2);
      map.$indexSet(0, "c", 3);
      map.$indexSet(0, 1, "10");
      P.print("map = " + map.toString$0(0) + ", map['c'] = " + H.S(map.$index(0, "c")) + ", map.runtimeType = " + new H.TypeImpl(H.getRti(map)).toString$0(0));
      P.print("---------------function literal---------------");
      P.print("fun.runtimeType = " + new H.TypeImpl(H.getRti(new V.main_closure())).toString$0(0));
      P.print("---------------default value---------------");
      P.print("lineCount = " + H.S(C.JSNull_methods.$add(null, 1)));
    },
    main_closure: {
      "^": "Closure:1;",
      call$1: function(value) {
        return value.$add(0, 1);
      }
    }
  }, 1]];
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.int, args: [P.int]}];
